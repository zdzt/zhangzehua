#ifndef SERIALYaduMASTER_H
#define SERIALYaduMASTER_H

#define RULESTATUTENAME	"亚都新风主规约"
...
class CSerialYaduMaster:public CSerialBaseGatherMaster<SProtocolInit>
{
public:
        CSerialYaduMaster();
        ~CSerialYaduMaster();
...
public:
	...
	int InitRule(SInterfaceComMaster &pf);
private:
        int StartWork();
};
